...
ChatLogic::~ChatLogic()
{
    ...
    // delete _chatBot; With moving semantics it is destructed automatically after scope


    // delete all nodes (they are now unique ptrs, no need to delete them)
    // for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    // {
    //     delete *it;
    // }

    // delete all edges (edges are now unique pointers, don't need to delete them manually)
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot local_chatbot_instance = ChatBot("../images/chatbot.png");
    local_chatbot_instance.SetChatLogicHandle(this);
    local_chatbot_instance.SetRootNode(rootNode);
    _chatBot = &local_chatbot_instance;
    rootNode->MoveChatbotHere(std::move(local_chatbot_instance));
